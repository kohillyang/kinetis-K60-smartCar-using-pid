...
void LCD_WrDat(byte data)
{
  ...
  while(i--)
  {
    if(data&0x80){GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(22));;;;}
    else{GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(22));;;;}
    GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(21)); 
    asm("nop");;;;
		//asm("nop");            
    GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(21));;;;;    
...
void LCD_WrCmd(byte cmd)
{
  ...
  while(i--)
  {
    if(cmd&0x80){GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(22));;;;;}
    else{GPIOB_PDOR &= ~GPIO_PDOR_PDO(GPIO_PIN(22));;;;;;}
    GPIOB_PDOR |=  GPIO_PDOR_PDO(GPIO_PIN(21));;;;;
    asm("nop");;;;
		//asm("nop");             
...
void LCD_Init(void)        
{
    ...
    GPIOC_PDDR=GPIO_PDDR_PDD(GPIO_PIN(7)|GPIO_PIN(15));
